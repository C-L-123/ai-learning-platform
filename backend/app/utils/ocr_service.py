...
class OCRService:
    ...
    def extract_knowledge_points(self, text, subject='数学'):
        """从文本中提取知识点"""
        # 预定义的知识点关键词映射
        knowledge_mapping = {
            '数学': [
        ...
        found_points = []
        keywords = knowledge_mapping.get(subject, knowledge_mapping['数学'])
    ...
    def generate_analysis_report(self, text, subject='数学'):
        """生成完整的学情分析报告"""
        knowledge_points = self.extract_knowledge_points(text, subject)
